...
public class TextItemTest {
    ...
    void setStyleId_exists_savesId(){
        assertDoesNotThrow(()->{textItem.setStyleId(0);});
    }
    @Test
    void setStyleId_doesNotExist_savesId(){
        assertDoesNotThrow(()->{textItem.setStyleId(122);});
    }
    ...
    void getAttributedString_zero_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.getAttributedString(0);});
    }

    @Test
    void getAttributedString_neg_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.getAttributedString(-1);});
    }

    @Test
    void getBoundingBox_normal_doesNotThrow(){
        assertDoesNotThrow(()->{textItem.getBoundingBox(graphics, slideViewerComponent, 1);});
    }
    @Test
    void getBoundingBox_graphicsNull_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.getBoundingBox(null, slideViewerComponent, 1);});
    }
    @Test
    void getBoundingBox_imageObserverNull_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.getBoundingBox(graphics, null, 1);});
    }

    @Test
    void getBoundingBox_scaleZero_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.getBoundingBox(graphics, slideViewerComponent, 0);});
    }

    @Test
    void getBoundingBox_scaleNeg_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.getBoundingBox(graphics, slideViewerComponent, -1);});
    }

    @Test
    void draw_normal_doesNotThrow(){
        assertDoesNotThrow(()->{textItem.draw(1, graphics, slideViewerComponent);});
    }
    @Test
    void draw_graphicsNull_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.draw(1, null, slideViewerComponent);});
    }
    @Test
    void draw_observerNull_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.draw(1, graphics, null);});
    }
    @Test
    void draw_scaleZero_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.draw(0, graphics, slideViewerComponent);});
    }
    @Test
    void draw_scaleNeg_throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class, ()->{textItem.draw(-1, graphics, slideViewerComponent);});
    }
    ...
    void getSaveString_normal_returnsString(){
        assertDoesNotThrow(()->{textItem.getSaveString();});
    ...
    void getSaveString_noStyle_throwsIllegalStateException(){
        textItem.setStyleId(-1);
        assertThrows(IllegalStateException.class, ()->{textItem.getSaveString();});
    }
}
